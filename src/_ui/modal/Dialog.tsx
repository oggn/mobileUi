...
import { Button, Txt, Row, IconTab, Absolute, Container, BlurLayer, Fixed } from '../index';
...
interface Props extends HTMLAttributes<HTMLElement> {
  ...
  tabSpaceTop?: number;
  tabs?:
    | { name: string; buttonColor?: string; txtColor?: string; onClick?: () => void }[]
    | undefined;
}
    ...
    <>
      ...
      >
        ...
        >
          ...
          {tabs?.length !== 0 && !!tabs && (
            <Row gap={tabSpaceGap} margin={{ top: tabSpaceTop ?? 18 }}>
              {tabs?.map((item: any) => (
                <Button
                  minHeight={52}
                  width="100%"
